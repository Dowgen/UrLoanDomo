    ...
    <div class="top-information">
      <div class="avatar-box">
        ...
        <div class="right">
          ...
          <input id="upfile" type="file" name="upfile" multiple="multiple" accept="image/png,image/jpg" class="accept" @change='compressImg'>
  ...
  //          console.log(that.userInfo);
      ...
      compressImg(){
        ...
        reader.onload = function(e) {
          var img = new Image,
              width = 480, //image resize
              quality = 0.8, //image quality
              canvas = document.createElement("canvas"),
              drawer = canvas.getContext("2d");
          img.src = this.result;
          img.onload = function() {  //目前存在问题：img.onload停不下来
          ...
          //上传
          that.uploadImg(img.src);
        }
      },
      uploadImg(src) {
        var fd = new FormData();
        fd.append("upload", 1);
        fd.append('upfile', src);
